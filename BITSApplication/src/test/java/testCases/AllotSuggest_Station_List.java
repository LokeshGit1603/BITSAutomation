...
public class AllotSuggest_Station_List extends CommonFunctions{
	...
	public void Verifysort() throws InterruptedException
	{
		...
		AllotSuggest_Station_List_Page_Objects.SortSName.click();
		Thread.sleep(1000);
		AllotSuggest_Station_List_Page_Objects.SortCity.click();
		Thread.sleep(1000);
		AllotSuggest_Station_List_Page_Objects.SortBD.click();
		Thread.sleep(1000);
		AllotSuggest_Station_List_Page_Objects.SortPC.click();
		Thread.sleep(1000);
	...
	public void VerifyInvalidSearch() throws Throwable
	{
		...
		AllotSuggest_Station_List_Page_Objects.SearchField.sendKeys(getExcelData("SStationList", 1, 1));
		Thread.sleep(2000);
	...
	public void VerifyBDomain() throws Throwable
	{
		...
		Thread.sleep(2000);
		AllotSuggest_Station_List_Page_Objects.SearchSelect.sendKeys(getExcelData("SStationList", 3, 0));
		Thread.sleep(2000);

		AllotSuggest_Station_List_Page_Objects.SearchField.sendKeys(getExcelData("SStationList", 3, 1));
		Thread.sleep(2000);

		AllotSuggest_Station_List_Page_Objects.SelectStatus.sendKeys(getExcelData("SStationList", 3, 2));
		Thread.sleep(2000);

		String BDomainResult = AllotSuggest_Station_List_Page_Objects.BDomainResult.getText();
	...
	public void VerifyParentCompany() throws Throwable
	{
		...
		Thread.sleep(2000);
		AllotSuggest_Station_List_Page_Objects.SearchSelect.sendKeys(getExcelData("SStationList", 4, 0));
		Thread.sleep(2000);
