...
public class Login extends CommonFunctions{
	...
	@Test(enabled = false)
	public void invalidUserandvalidPassword() throws Throwable
	{
		extenttestCase.log(Status.INFO, "Verifying Login Authentication with Invalid User Id and Valid Password");
		...
		{
			extenttestCase.log(Status.PASS, "Login validation done with Invalid User Id and Valid Password");
		}
		
		else
		{
			extenttestCase.log(Status.INFO, "Login validation Failed with Invalid User Id and Valid Password");
		}
	...
	public void ValidUserIdandPassword() throws Throwable
	{
		...
		extenttestCase.log(Status.PASS, "Login validation done with Valid User Id and Valid Password");
