...
public class ExcelUtils {
	...
	static XSSFSheet sheet;
	 ...
	 public static String getExcelData(String sheetName, int rowNum, int colNum) throws Throwable{
		 FileInputStream fis = new FileInputStream("D:\\Eclipse\\Workspace\\BITSApplication\\excel\\TestData.xlsx");
		 ...
		 FileInputStream fis = new FileInputStream("D:\\Eclipse\\Workspace\\BITSApplication\\excel\\TestData.xlsx");
		      ...
		      FileOutputStream fos = new FileOutputStream("D:\\Eclipse\\Workspace\\BITSApplication\\excel\\\\TestData.xlsx");
		 wb.write(fos);
		 wb.close();
		 }
